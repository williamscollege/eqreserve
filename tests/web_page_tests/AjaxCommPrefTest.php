<?php
	...
	class AjaxCommPrefTest extends WMSWebTestCase {
		...
		function testCommPrefAjaxUserCanNotAccessOthersCommPref() {
			...
			$this->get('http://localhost'.LOCAL_WEBSERVER_PORT_SPEC.'/eqreserve/ajax_actions/ajax_comm_pref.php?comm_pref=107&commPrefAction=setReminder&actionVal=false');
		...
		function testCommPrefAjaxInvalidAction() {
			...
			$this->get('http://localhost'.LOCAL_WEBSERVER_PORT_SPEC.'/eqreserve/ajax_actions/ajax_comm_pref.php?comm_pref=101&commPrefAction=superpowers&actionVal=foo123bar');
		...
		function testCommPrefSetReminder() {
			...
			$this->get('http://localhost'.LOCAL_WEBSERVER_PORT_SPEC.'/eqreserve/ajax_actions/ajax_comm_pref.php?comm_pref=101&commPrefAction=setReminder&actionVal=1');
		...
		function testCommPrefSetAlertCreate() {
			...
			$this->get('http://localhost'.LOCAL_WEBSERVER_PORT_SPEC.'/eqreserve/ajax_actions/ajax_comm_pref.php?comm_pref=101&commPrefAction=setAlertCreate&actionVal=1');
		...
		function testCommPrefSetAlertCancel() {
			...
			$this->get('http://localhost'.LOCAL_WEBSERVER_PORT_SPEC.'/eqreserve/ajax_actions/ajax_comm_pref.php?comm_pref=101&commPrefAction=setAlertCancel&actionVal=1');

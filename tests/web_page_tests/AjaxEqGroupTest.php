...
class AjaxEqGroupTest extends WMSWebTestCase {
    ...
    function testEqGroupAjaxRemoveConsumerAccess() {
        ...
        // other user access
        $this->get('http://localhost/eqreserve/ajax_eq_group.php?eq_group=201&ajaxVal_action=removePermission&permission_ids[]=718');
        $this->assertPattern('/"status":"success"/');
        ...
        $this->get('http://localhost/eqreserve/ajax_eq_group.php?eq_group=201&ajaxVal_action=removePermission&permission_ids[]=702');
        $this->assertPattern('/"status":"success"/');
        $p = Permission::getOneFromDb(['permission_id'=>702],$this->DB);
        $this->assertFalse($p->matchesDb);

        // inst group access
        $this->get('http://localhost/eqreserve/ajax_eq_group.php?eq_group=201&ajaxVal_action=removePermission&permission_ids[]=711');
        $this->assertPattern('/"status":"success"/');
    ...
    function testEqGroupAjaxRemoveMultipleAccess() {
        ...
        $this->get('http://localhost/eqreserve/ajax_eq_group.php?eq_group=201&ajaxVal_action=removePermission&permission_ids[]=719&permission_ids[]=718&permission_ids[]=702&permission_ids[]=711');
    ...
    function testEqGroupAjaxRemoveManagerAccess() {
        ...
        // other user access
        $this->get('http://localhost/eqreserve/ajax_eq_group.php?eq_group=201&ajaxVal_action=removePermission&permission_ids[]=719');
        $this->assertPattern('/"status":"success"/');
        $p = Permission::getOneFromDb(['permission_id'=>719],$this->DB);
        $this->assertFalse($p->matchesDb);
    }
    ...
    function testEqGroupAjaxNonAdminCannotRemoveTheirOwnManagerAccess() {
        ...
        // direct
        $this->get('http://localhost/eqreserve/ajax_eq_group.php?eq_group=203&ajaxVal_action=removePermission&permission_ids[]=703');
        $this->assertPattern('/"status":"failure"/');
        $p = Permission::getOneFromDb(['permission_id'=>703],$this->DB);
        $this->assertTrue($p->matchesDb);

        // indirect, via inst group
        $this->get('http://localhost/eqreserve/ajax_eq_group.php?eq_group=201&ajaxVal_action=removePermission&permission_ids[]=707');
        $this->assertPattern('/"status":"failure"/');

...
function createTestData_Schedules($dbConn) {
    // 1000 series ids
    // schedule: schedule_id, type, user_id, notes, frequency_type, repeat_interval, which_days, start_time, duration_minutes, end_time, end_on_date, summary, flag_delete

<?php
	...
	class TestOfEqSubgroup extends WMSUnitTestCaseDB
	{
        ...
        function testEqSubgroupFieldPresenceAndOrder(){
            $this->assertEqual(8,count(EqSubgroup::$fields));
            ...
            $this->assertEqual('reference_link',EqSubgroup::$fields[4]);
            $this->assertEqual('ordering',EqSubgroup::$fields[5]);
            $this->assertEqual('flag_is_multi_select',EqSubgroup::$fields[6]);
            $this->assertEqual('flag_delete',EqSubgroup::$fields[7]);
        }

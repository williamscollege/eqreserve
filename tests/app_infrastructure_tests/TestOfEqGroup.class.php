...
//$this->dump($eg->eq_items);
        ...
        public function TestOfToListItemLinked(){
            ...
            $this->assertEqual($eg->toListItemLinked(),'<li><a href="equipment_group.php?eid=201" title="testEqGroup1">testEqGroup1</a>: on the 1/4 hour with 15 minute min and 1 hour max by 15 minute intervals (You manage this group)</li>');
        }

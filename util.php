<?php
	...
	#------------------------------------------------#
	# takes: a value from an HTTP request
	# returns: a version of that value that's safe for use in SQL queries
	# NOTE: this automatically puts quotes around non-numeric values
	# NOTE: trim fxn strips (various types of) whitespace characters from the beginning and end of a string

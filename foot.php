...
<footer>
    ...
    <div id="modalHelp" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalHelpLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            ...
            <p><i class="icon-question-sign"></i> Still need help? Please contact: <a href="mailto:itech@williams.edu?subject=EqReserve_Help_Request">[TODO: send to group manager OR itech@williams.edu]</a></p>
        </div>

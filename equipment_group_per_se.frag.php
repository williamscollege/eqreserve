<?php
	...
	if ($USER->flag_is_system_admin || $is_group_manager) {
		...
		<div id="managerEdit" class="hide">
			<form action="ajax_actions/ajax_eq_group.php" class="form-horizontal" id="formEditGroup" name="formEditGroup" method="post">
		...
		<div id="modalAddUserUI" class="modal hide" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modalAddUserUILabel" aria-hidden="true">
			...
			<div class="modal-body">
				<form>
					...
					<div id="addUserSearchResultsPreview" class="control-group addUserSearchResultsPreview"><ul class="unstyled userGroupSearchResultList"><li class="text-info"><i>type above to start a search</i></li></ul></div>
				</form>
			</div>
